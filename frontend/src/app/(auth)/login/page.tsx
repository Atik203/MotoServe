...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-65px)] items-center justify-center bg-background px-[32px] py-[48px]">
      <div className="flex w-full max-w-[1152px] items-stretch overflow-hidden rounded-[12px] border border-[#e2e8f0] bg-white shadow-[0_1px_2px_0px_rgba(0,0,0,0.05)]">
        <div className="relative flex w-[460px] shrink-0 flex-col justify-between overflow-hidden border-r border-[#e2e8f0] bg-white px-[40px] py-[40px]">
        ...
        <div className="relative flex items-center gap-[8px]">
          ...
          <span className="w-[146px] text-[24px] font-semibold tracking-[-0.6px] text-primary">
            MotoServe
          </span>
        </div>

        <div className="relative flex max-w-[512px] flex-col gap-[16px]">
          ...
          <div className="flex gap-[16px] pt-[16px]">
            <div className="flex items-center gap-[8px] rounded-[8px] border border-[#e2e8f0] bg-[rgba(243,244,245,0.8)] p-[17px] shadow-[0_1px_2px_0px_rgba(0,0,0,0.05)] backdrop-blur-[2px]">
              ...
              <div>
                <p className="text-[12px] font-semibold tracking-[0.6px] text-foreground uppercase">
                  Job Cards
                </p>
      ...
      <div className="flex flex-1 items-center justify-center bg-[#f8f9fa] p-[32px]">
        <div className="flex w-full max-w-[440px] flex-col gap-[24px] rounded-[16px] border border-[#e2e8f0] bg-white p-[41px] shadow-[0_8px_15px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-center">
            <h2 className="text-[24px] font-semibold tracking-[-0.6px] text-foreground">
              Welcome Back
            </h2>
          ...
          <form
            className="flex flex-col gap-[24px] py-[8px]"
          ...
          >
            ...
            <div className="flex flex-col gap-[8px]">
              <div className="flex items-center justify-between">
                ...
                <span
                  className="cursor-pointer text-[12px] font-semibold tracking-[0.24px] text-primary"
            ...
            <label className="flex w-fit cursor-pointer items-center gap-[8px]">
              <Checkbox
                ...
                className="rounded-[4px] border-[#e2e8f0]"
              />
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="flex h-[44px] gap-[8px] rounded-[8px] shadow-[0_1px_2px_0px_rgba(0,0,0,0.05)]"
            >
