    ...
    <div className="bg-background min-h-screen p-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
        <div>
          ...
          <p className="text-base text-[#414754]">Here is the latest overview of your fleet operations.</p>
        </div>
        ...
        <div className="grid grid-cols-12 items-start gap-6">
          <div className="col-span-12 flex gap-4">
            {kpis.map((kpi) => {
              ...
              return (
                <div key={kpi.id} className="flex h-32 w-[174px] flex-col justify-between rounded-xl border border-[#e2e8f0] bg-white p-[17px] shadow-[0_1px_1px_rgba(0,0,0,0.05)]">
                  <div className="flex w-full items-start justify-between">
                    <span className="text-xs font-semibold tracking-[0.6px] text-[#414754] uppercase">
                  ...
                  <div>
                    <p className={cn("text-2xl font-semibold tracking-[-0.24px] text-foreground", kpi.id === "kpi-305" && "truncate text-sm leading-5")}>
                      {kpi.value}
                    </p>
                    <p className={cn("flex items-center gap-1 text-[11px] font-medium", kpi.trend === "up" && "text-[#4caf50]", kpi.trend === "down" && "text-[#ba1a1a]")}>
              ...
              {activeJob && activeVehicle ? (
                <>
                  ...
                  <div className="relative py-4">
                    ...
                    <div className="absolute top-8 left-[5.65%] h-0.5 bg-primary" style={{ width: "45%" }} />
                  ...
                  <div key={vehicle.id} className="flex-1 overflow-hidden rounded-xl border border-[#e2e8f0] bg-white shadow-[0_1px_2px_0px_rgba(0,0,0,0.05)]">
                    ...
                    <div className="flex flex-col gap-2 p-4">
                      ...
                      <div className="flex gap-2">
                        <Link href="/dashboard/history" className="rounded-lg border border-[#e2e8f0] px-3 py-[9px] text-[11px] font-semibold text-foreground hover:bg-muted">
                          History
                        </Link>
                        <Link href="/dashboard/appointments/book" className="rounded-lg bg-[rgba(216,226,255,0.2)] px-3 py-[9px] text-[11px] font-semibold text-primary hover:bg-[rgba(216,226,255,0.35)]">
                          Book
                        </Link>
                      </div>
                    </div>
          ...
          <div className="col-span-4 flex flex-col gap-6">
            <section className="flex flex-col gap-4 rounded-xl border border-[#e2e8f0] bg-white p-[17px] shadow-[0_1px_1px_rgba(0,0,0,0.05)]">
              ...
              {[
                ...
                <div key={n.title} className={cn("flex gap-2 rounded-lg p-2", n.row && "bg-[rgba(216,226,255,0.1)]")}>
                  ...
                  <div>
                    ...
                    <p className="text-xs leading-[18px] text-[#414754]">{n.body}</p>
